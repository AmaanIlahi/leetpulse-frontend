...
export default function DashboardPage() {
  ...
  const difficultyChartData = [
    { name: "Easy", solved: data.progress.easy.solved },
    { name: "Medium", solved: data.progress.medium.solved },
    { name: "Hard", solved: data.progress.hard.solved },
  ];
  ...
  return (
    <main className="min-h-screen bg-zinc-950 text-white p-8 space-y-12">
      ...
      {/* Difficulty Chart */}
      {/* <div className="bg-zinc-900 p-6 rounded-xl h-[360px]">
              ...
              <div className="space-y-2">
                {insights.focus_topics.map((ft, i) => (
                  <div key={i} className="bg-zinc-800 p-3 rounded">
                    ...
                    <p className="text-sm text-zinc-400">{ft.reason}</p>
                  </div>
                ))}
              </div>
            </div>
